    ...
    def get_node_config(self):
        return NodeConfig(
            ...
            fields=[
                ...
                Field(name="resolution_width", label="📐 Resolution Width", type="inputInt",
                      required=False, defaultValue=640,
                      description="Camera resolution width."),
                Field(name="resolution_height", label="📐 Resolution Height", type="inputInt",
                      required=False, defaultValue=480,
                      description="Camera resolution height."),
                Field(name="jpeg_quality", label="🖼️ JPEG Quality", type="inputInt",
                      required=False, defaultValue=85,
                      description="JPEG compression quality (1-100)."),
                Field(name="read_attempts", label="🔄 Frame Read Attempts", type="inputInt",
                      required=False, defaultValue=5,
                      description="Number of frame read attempts."),
                Field(name="warmup_ms", label="⏱️ Camera Warmup Time (ms)", type="inputInt",
                      required=False, defaultValue=150,
                      description="Camera warmup time in milliseconds."),
                Field(name="stream_mode", label="📺 Camera Stream Mode", type="select",
                      required=False, defaultValue=1,
                      options=[{"label": "📸 Single Shot", "value": 0},
                               {"label": "🎥 Continuous Streaming", "value": 1}],
                      description="Camera capture mode."),
                Field(name="target_fps", label="🎯 Target Frame Rate (FPS)", type="inputFloat",
                      required=False, defaultValue=15.0,
                      description="Approximate FPS while streaming."),
                Field(name="init_timeout_ms", label="⏰ Initialization Timeout (ms)", type="inputInt",
